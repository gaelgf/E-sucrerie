<?php /* Smarty version Smarty-3.1.19, created on 2016-04-22 11:48:22
         compiled from "/home/u405142996/public_html/themes/default-bootstrap/history.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1600583806571a0f862e4980-33771273%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '18da11ae1f50e3438881c886146c7292ebc5aeb2' => 
    array (
      0 => '/home/u405142996/public_html/themes/default-bootstrap/history.tpl',
      1 => 1461324274,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1600583806571a0f862e4980-33771273',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_571a0f86421f44_63979615',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_571a0f86421f44_63979615')) {function content_571a0f86421f44_63979615($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_regex_replace')) include '/home/u405142996/public_html/tools/smarty/plugins/modifier.regex_replace.php';
?>
...
<?php $_tmp80=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order-detail',true,null,"id_order=".$_tmp80), ENT_QUOTES, 'UTF-8', true);?>
');">
...
, '<?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['order']->value['id_order']);?>
<?php $_tmp81=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order-detail',true,null,"id_order=".$_tmp81), ENT_QUOTES, 'UTF-8', true);?>
');">
								<span>
...
<?php $_tmp82=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order-opc',true,null,"submitReorder&id_order=".$_tmp82), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Reorder'),$_smarty_tpl);?>
">
							<?php } else { ?>
								<a class="link-button" href="<?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['order']->value['id_order']);?>
<?php $_tmp83=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order',true,null,"submitReorder&id_order=".$_tmp83), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Reorder'),$_smarty_tpl);?>
">
							<?php }?>
